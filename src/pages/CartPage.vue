<template>
  <q-page>
    <!-- <div style="position: absolute; z-index: -999; width: 100vw; height: 100vh; background-color: #f0f0f0;"></div> -->
    <div class="q-pa-md" style="width: 100%; height: 100%; background-color: #f0f0f0;">
      ...
      <div v-if="currentOrderId !== null" class="row q-gutter-md justify-center">
        <q-card flat bordered class="col-12 col-md-6 full-height">
          ...
          <q-card-section v-if="order.sunglassesDetails && order.sunglassesDetails.length > 0" class="q-gutter-md">
            <div v-for="sunglass in order.sunglassesDetails" :key="sunglass._id" class="row justify-start items-center cursor-pointer" @click="viewSunglassesDetails(sunglass._id)" >
              ...
              <q-item-section class="col-8">
                ...
                <div class="font-size-responsive-sm limit-text-2 q-mb-sm">{{ capitalizeFirstLetter(sunglass.description) }}</div>
                <!-- <div class="row justify-start">
                  <div class="font-size-responsive-sm q-mr-md"><b>Color: </b>{{ capitalizeFirstLetter(sunglass.color) }}</div>
                  <div class="font-size-responsive-sm">R {{ sunglass.price }}.00</div>
                </div> -->
              </q-item-section>
            </div>
          </q-card-section>
          ...
          <q-card-section class="q-gutter-md">
            <q-btn rounded color="black" text-color="white" dense @click="cancelOrder(order._id)" class="q-px-lg custom-button font-size-responsive-sm" label="Clear Cart" style="opacity: 1" />
            <q-btn rounded dense flat to="/sunglasses" class="q-px-lg custom-button font-size-responsive-sm" label="Continue Shopping" style="opacity: 0.9" />
          </q-card-section>
        </q-card>
        ...
        <div class="col-12 col-md-3">
          <div class="q-gutter-md">
            ...
            <q-card flat bordered>
              <q-card-section>
                <div class="font-size-responsive-xl">Cart Summary</div>
              </q-card-section>
              ...
              <q-card-section class="q-pa-none q-px-md q-pb-md">
                <q-btn rounded dense color="black" text-color="white" to="/buy/review" label="Proceed to checkout" class="q-px-lg custom-button font-size-responsive-md" style="width: 100%;" />
              </q-card-section>
            </q-card>

            <q-card flat bordered class="q-pa-md">
              <q-card-section class="row items-center font-size-responsive-sm">
