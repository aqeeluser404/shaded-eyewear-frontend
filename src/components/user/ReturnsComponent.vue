<template>
  ...
  <div v-if="ordersRefunded.length > 0" >
          ...
          <q-card-section class="row justify-between flex-center">
            ...
            <div>
              <div>
                ...
                <div class="text-caption"><b>Returned on: {{ formatDate(order.orderDate) }}</b></div>
              </div>
            </div>
          </q-card-section>
          <q-separator />
    ...
    <q-card flat bordered class=" col-12 col-md-5 full-height" v-if="selectedReturn">
        <!-- <div class="">
          <q-card-section>
            <div class="font-size-responsive-lg"><b>Return Details</b></div>
          </q-card-section>
        </div> -->
        ...
        <div class="">
          <q-card-section class="row justify-between flex-center q-gutter-md">
            <div>
              ...
              <!-- <div class="text-caption">Customer ID: #{{ selectedReturn.user }}</div> -->
            </div>
            <div>
        ...
        <q-card-section>
          <q-btn rounded dense class="q-px-lg custom-button font-size-responsive-sm" label="Back" color="primary" @click="closeReturnDetails" />
        </q-card-section>
    </q-card>
  </div>
